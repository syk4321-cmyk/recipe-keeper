...
export default function LoginScreen() {
  ...
  // 게스트로 시작하기: Firebase 익명 로그인.
  // 나중에 "구글 계정 연결하고 백업하기" 기능을 만들 때는 여기서 생긴 익명
  // UID에 linkWithCredential(auth.currentUser, GoogleAuthProvider.credential(idToken))로
  // 구글 자격증명을 연결해서 승격시키면 됨(게스트 때 데이터가 안 날아감).
  // 지금은 그 연결 UI는 만들지 않고, 핸들러만 독립적으로 분리해둠.
